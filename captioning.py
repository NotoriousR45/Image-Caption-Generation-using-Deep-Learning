...
word_to_index = {}
with open("F:\\Rohitpro\\models\\word_to_idx.pkl", 'rb') as file:
    word_to_index = pd.read_pickle(file, compression=None)

index_to_word = {}
with open("F:\\Rohitpro\\models\\idx_to_word.pkl", 'rb') as file:
    index_to_word = pd.read_pickle(file, compression=None)

print("Loading the model...")
model = load_model("F:\\Rohitpro\\models\\model_14.h5")
